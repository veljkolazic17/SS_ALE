...
EMULATOR_FILES = ./misc/src/Codes.c ./src/Emulator.cpp ./src/handler_helpers.cpp ./src/emulator_loader.cpp ./src/instruction_handlers.cpp ./main/main_emulator.cpp
...
$(EMULATOR):
			$(CC) $(CFLAGS) -o $(EMULATOR) $(EMULATOR_FILES)
